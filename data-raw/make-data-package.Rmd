...
```{r}
rnor.rnaseq.transcript <- ExpressionSet(assayData = transcript.assayData,
                             phenoData = phenoData,
                             experimentData = experimentData,
...
```{r,eval=FALSE}
usethis::use_data(rnor.rnaseq.gene,internal = FALSE, overwrite = TRUE)
usethis::use_data(rnor.rnaseq.transcript,internal = FALSE, overwrite = TRUE)
```
